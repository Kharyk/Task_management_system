...
class Project(models.Model):
    ...
    image = models.ImageField(upload_to='pr_img/', blank=True, null=True)
    files = models.FileField(upload_to='pr_files/', blank=True, null=True)
...
class Task(models.Model):
    ...
    description = models.TextField()
    image = models.ImageField(upload_to='ts_img/', blank=True, null=True)
    files = models.FileField(upload_to='ts_files/', blank=True, null=True)
